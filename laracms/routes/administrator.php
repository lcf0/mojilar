...
Route::group(['domain' => config('administrator.domain'), 'prefix' => config('administrator.uri'), 'namespace' => 'Administrator', 'middleware' => ['auth'], ], function () {
    ...
    #测试路由
    Route::get('ceshi/index','CeshiController@index')->name('ceshi.index');

    #关于墨迹
    /*介绍列表*/
    Route::resource('about', 'AboutController', ['only' => ['index', 'show', 'create', 'store', 'update', 'edit', 'destroy']]);
    #墨迹之路
    Route::resource('road', 'RoadController', ['only' => ['index', 'show', 'create', 'store', 'update', 'edit', 'destroy']]);


});

Route::group(['domain' => config('administrator.domain'), 'prefix' => config('administrator.uri'), 'namespace' => 'Content', 'middleware' => [], ], function () {
    #墨迹动态
    Route::resource('dynamic', 'DynamicController', ['only' => ['index', 'show', 'create', 'store', 'update', 'edit', 'destroy']]);
    #招聘
    Route::resource('hiring', 'HiringController', ['only' => ['index', 'show', 'create', 'store', 'update', 'edit', 'destroy']]);
    #品牌案例
    Route::resource('brand', 'BrandController', ['only' => ['index', 'show', 'create', 'store', 'update', 'edit', 'destroy']]);
    #发版管理
    Route::resource('issue', 'IssueController', ['only' => ['index', 'show', 'create', 'store', 'update', 'edit', 'destroy']]);
    #升级日志
    Route::resource('uplog', 'UplogController', ['only' => ['index', 'show', 'create', 'store', 'update', 'edit', 'destroy']]);
    #常见问题
    Route::resource('problem', 'ProblemController', ['only' => ['index', 'show', 'create', 'store', 'update', 'edit', 'destroy']]);
    #服务协议
    Route::resource('protocol', 'ProtocolController', ['only' => ['index', 'show', 'create', 'store', 'update', 'edit', 'destroy']]);
    #资讯
    Route::resource('info', 'InfoController', ['only' => ['index', 'show', 'create', 'store', 'update', 'edit', 'destroy']]);
    #图片管理
    Route::resource('img', 'ImgController', ['only' => ['index', 'show', 'create', 'store', 'update', 'edit', 'destroy']]);
    #图片管理
    Route::resource('video', 'VideoController', ['only' => ['index', 'show', 'create', 'store', 'update', 'edit', 'destroy']]);
     #商务合作类型
    Route::resource('bname', 'BnameController', ['only' => ['index', 'show', 'create', 'store', 'update', 'edit', 'destroy']]);
    #商务联系方式
    Route::resource('bcontact', 'BcontactController', ['only' => ['index', 'show', 'create', 'store', 'update', 'edit', 'destroy']]);
});
