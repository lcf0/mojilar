...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tCaption = '<div class="file-caption form-control {class}" style="width:85%" tabindex="500">\n' +
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    dragSettings: {},
                    indicatorNew: '<i class="icon-plus-sign"></i>',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            prev: '<i class="icon-resize-triangle-left"></i>',
            next: '<i class="icon-resize-triangle-right"></i>',
            toggleheader: '<i class=" icon-exchange"></i>',
            fullscreen: '<i class="icon-fullscreen"></i>',
            borderless: '<i class="icon-resize-full"></i>',
            close: '<i class="icon-remove-circle"></i>'
        },
        ...
        customLayoutTags: {},
        customPreviewTags: {},
        previewFileIcon: '<i class="icon-resize-file"></i>',
        ...
        removeIcon: '<i class="icon-resize-trash"></i>',
        removeClass: 'btn btn-default btn-secondary',
        cancelIcon: '<i class="icon-ban-circle"></i>',
        cancelClass: 'btn btn-default btn-secondary',
        uploadIcon: '<i class="icon-resize-upload"></i>',
